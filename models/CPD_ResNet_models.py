...
class CPD_ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return [F.upsample(self.upsample3(attention_map), size=(320, 320), mode='bilinear', align_corners=False), F.upsample(self.upsample3(detection_map), size=(320, 320), mode='bilinear', align_corners=False)]
        # return [self.upsample1(x4_2), self.upsample2(x3_2), self.upsample3(x2_2), self.upsample1(x4_1), self.upsample2(x3_1), self.upsample3(x2_1)]
